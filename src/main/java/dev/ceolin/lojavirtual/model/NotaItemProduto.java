...
@SequenceGenerator(name = "seq_nota_item_compra", 
sequenceName = "seq_nota_item_compra", allocationSize = 1, initialValue = 1)
public class NotaItemProduto implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_nota_item_compra")
	private Long id;
